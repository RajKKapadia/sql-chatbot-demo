...
def get_chat_completion_prompt(query: str, formated_chat_history: list[dict]) -> str:
    chat_completion_prompt = f'''Consider yourselk as a helpful data analyst of Netcome Learning. A user has asked a \
...
If there is a course URL in the SQL data only then provide it in the answer otherwise don't mention the URL in the awnser. \
